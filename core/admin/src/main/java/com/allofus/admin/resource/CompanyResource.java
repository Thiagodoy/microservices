...
public class CompanyResource extends Resource<CompanyRequest, CompanyResponse, CompanyService,CompanyMapper> {

    public CompanyResource(CompanyMapper mapper, CompanyService service) {
